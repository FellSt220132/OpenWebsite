      ...
      <body className="bg-gray-900 text-gray-100 font-mono flex flex-col min-h-screen">
        ...
        <header className="bg-gray-800/80 backdrop-blur-md shadow-lg border-b border-gray-700 fixed w-full z-50">
          <nav className="max-w-6xl mx-auto flex justify-center space-x-6 py-4">
            ...
            <a href="https://fellst220132.github.io/OpenWebsite/requirements" className="text-gray-100 hover:text-cyan-400 transition-colors font-semibold tracking-wide">Anforderungen</a>
            <a href="https://fellst220132.github.io/OpenWebsite/development" className="text-gray-100 hover:text-cyan-400 transition-colors font-semibold tracking-wide">Entwicklung</a>
            <a href="https://fellst220132.github.io/OpenWebsite/team" className="text-gray-100 hover:text-cyan-400 transition-colors font-semibold tracking-wide">Team</a>
          </nav>
        </header>
